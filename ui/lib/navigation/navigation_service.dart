...
class NavigationService {
  ...
  Future<dynamic> navigateTo(String routeName, {dynamic arguments}) {
    Uri url = Uri(path: routeName);
    if (arguments != null) {
      url = Uri(queryParameters: arguments, path: routeName);
    }
    return navigatorKey.currentState
        .pushNamed(url.toString(), arguments: arguments);
  }
  ...
  bool goBack<T extends Object>({T result, String until}) {
    print(
        "goBack called : ${navigatorKey.currentState.context.widget.toStringShort()} $result");
  ...
  Future<dynamic> pushAndRemoveUntil<T extends Object>(
      String routeName, String routeUntil) {
    return navigatorKey.currentState
